...
available:
 ...
 - [Standalone jar](https://gitlab.com/pdftk-java/pdftk/-/jobs/artifacts/v3.1.2/file/build/libs/pdftk-all.jar?job=gradle), including dependencies. Requires a JRE at runtime.
 - [Native Image](https://gitlab.com/pdftk-java/pdftk/-/jobs/artifacts/v3.1.2/file/build/native-image/pdftk?job=nativeimage) for x86_64 GNU/Linux systems. Does not require any runtime dependencies.
