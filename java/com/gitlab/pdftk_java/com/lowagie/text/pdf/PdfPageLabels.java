...
import com.gitlab.pdftk_java.com.lowagie.text.factories.RomanAlphabetFactory;
import com.gitlab.pdftk_java.com.lowagie.text.factories.RomanNumberFactory;
...
public class PdfPageLabels {
    ...
    // pdftk-java required in PdfPageLabel.BuildPageLabels
    public PdfDictionary getDictionary() {
        PdfDictionary dic = new PdfDictionary();
        PdfArray array = new PdfArray();
        for (Map.Entry<Integer, PdfDictionary> obj : map.entrySet()) {
            array.add(new PdfNumber(obj.getKey()));
